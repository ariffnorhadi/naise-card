    ...
    <div className="space-y-8">
      <header className="text-center">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto">
          Explore React concepts through interactive components. This project
          demonstrates fundamental React concepts like components, state
          management, and event handling.
        </p>
      </header>

      <div className="grid md:grid-cols-2 gap-8">
        <Counter initialCount={0} title="Step Counter" />
        <Greeting />
      </div>
